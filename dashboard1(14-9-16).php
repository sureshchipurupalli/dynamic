...
if($_GET['cid']!="" && $_GET['sid']!='' && $_GET['fromdate']=="" && $_GET['todate']==""){
...
} else if($_GET['sid']=='' && $_GET['fromdate']=="" && $_GET['todate']=="" && $_GET['cid']!=""){
...
if($_GET['fromdate']!="" && $_GET['todate']!="" & $_GET['sid']!="" && $_GET['cid']!="" ){
...
} else if($_GET['fromdate']!="" && $_GET['todate']!="" & $_GET['sid']=="" && $_GET['cid']!=""){
...
$closedcompliants = $frontend_obj->closedcompcnt($_GET);
$closedcompcnt = count($closedcompliants);
...
{
	$countrycomplaints1=$frontend_obj->getcomplaintsbycountry1($_GET['cid'],$_GET['countid']);
	$totcompliant = count($countrycomplaints1);
	$closedcompbycountry=$frontend_obj->getclosedcomplaintsbyid($_GET['cid'],$_GET['countid']);
	$allcompbycountry=$frontend_obj->getallcomplaintsofcountry($_GET['cid'],$_GET['countid']);
	}

if($_GET['cid']!='' && $_GET['sid']!='' && $_GET['countid']!='')
{
	$countrycomplaints=$frontend_obj->getcomplaintsbycountry2($_GET['cid'],$_GET['sid'],$_GET['countid']);
	$totcompliant1 = count($countrycomplaints);
}

if($_GET['cid']!='' && $_GET['fromdate']!='' && $_GET['todate']!="" && $_GET['countid']!='')
{
	$countrycomplaints=$frontend_obj->getcomplaintsbycountry3($_GET['cid'],$_GET['sid'],$_GET['countid'],$_GET['fromdate'],$_GET['todate']);
}

if($_GET['cid']!='' && $_GET['sid']!='' && $_GET['fromdate']!='' && $_GET['todate']!='' && $_GET['countid']!='')
{}
...
$searchdate = $frontend_obj->selectdatetosearch($_POST);
	...
	/*if($_GET['sid']!=""){
		 header("location:".SITEURL."/dashboard1.php?cid=".$_GET['cid']."&sid=".$_GET['sid']."&fromdate=".$_POST['fromdate']."&todate=".$_POST['todate']." "; 
		 exit;
		 
	}else {
	
	header("location:".SITEURL."/dashboard1.php?cid=".$_GET['cid']."&fromdate=".$_POST['fromdate']."&todate=".$_POST['todate']." "; 
		 exit;
...
<?php /*<div class="legal_relese_fund">
                             <span class="para1">Status</span>
                             <p ><?php echo $catcomp->reviews;?> 
...
<?php } elseif( $_GET['cid']!=""&& $_GET['count_id']!=""){?>

    <p><a href="rankcategory.php?cid=<?php echo $_GET['cid']?>">Total Posted Cases: <?php echo count($totcompliant);?></a>, <?php if($closedcompbycountry != 0){?><a href="rankcategory.php?cid=<?php echo $_GET['cid']?>&status=Closed">Completed Cases: <?php echo $closedcompbycountry;?></a><?php }else{?> Completed Cases: <?php echo $closedcompbycountry;?> <?php }?></p>
