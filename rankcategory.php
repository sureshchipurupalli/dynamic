...
else if($_GET['status']=='Closed' && $_GET['sid']=="" && $_GET['cid']!="" && $_GET['countid']!=''){
	
	$catcompliants = $frontend_obj->getclosedcountrycomplaints($_GET['cid'],$_GET['countid']);
	
}

else if($_GET['status']=='Open' && $_GET['sid']=="" && $_GET['cid']!="" && $_GET['countid']!=''){
	
	$catcompliants = $frontend_obj->getopencountrycomplaints($_GET['cid'],$_GET['countid']);
	
}else if($_GET['cid']!="" && $_GET['countid']!="" && $_GET['sid']==""){
...
<h2 style="padding:25px 25px; text-align:center;font-family:  'Open Sans', sans-serif;"><?php echo ucfirst($getcategoryname->name); ?> - <?php echo ucfirst($subcatname->department_name);?></h2>

<?php } else {?>

<h2 style="padding:25px 25px; text-align:center;font-family:  'Open Sans', sans-serif;"><?php echo ucfirst($getcategoryname->name);?></h2>
