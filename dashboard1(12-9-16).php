...
if($_GET['sid']!='' && $_GET['fromdate']=="" && $_GET['todate']==""){
...
$closedcompcnt = count($closedcompliants);
 ...
 $sp  = "select sum(price) as sumprice from tb_complaints where complaint_category='".$_GET['cid']."' and department='".$_GET['sid']."' and date_added between '".$fromdate."' and '".$todate."' ";
$res = mysql_query($sp);
$fetch = mysql_fetch_object($res);

 $cuser  = "select count(DISTINCT(user_id)) as totalusers from tb_complaints where complaint_category='".$_GET['cid']."' and department='".$_GET['sid']."' and date_added between '".$fromdate."' and '".$todate."' ";
$cres = mysql_query($cuser);
$cfetch = mysql_fetch_object($cres);
...
$sp  = "select sum(price) as sumprice from tb_complaints where complaint_category='".$_GET['cid']."' and date_added between '".$fromdate."' and '".$todate."' ";
$res = mysql_query($sp);
$fetch = mysql_fetch_object($res);

$cuser  = "select count(DISTINCT(user_id)) as totalusers from tb_complaints where complaint_category='".$_GET['cid']."' and date_added between '".$fromdate."' and '".$todate."' ";
$cres = mysql_query($cuser);
$cfetch = mysql_fetch_object($cres);
...
<div class="about-text">
	<div class="mid_wrap">
	<p><?php echo $getcategoryname->description;?></p>
...
<form name="calendrasearch" method="post">
	...
	<input type="text" class="search_dates" placeholder="Enter From date" name="fromdate" id="fromdate" />

	<input type="text" class="search_dates" placeholder="Enter To date" name="todate" id="todate" />
	
	<input type="hidden" class="search_dates"  name="cid"  value="<?php echo $_GET['cid'];?>"/>
	<?php if($_GET['sid']!=""){?>
	<input type="hidden" class="search_dates"  name="sid" value="<?php echo $_GET['sid'];?>" />
	<?php }?>
