...
<div class="barChart">
        ...
        <div class="barChart__row" data-value="<?php echo $roadcount;?>">
         ...
         <span class="barChart__bar"><span class="barChart__barFill" style="text-align:right"><span class="scorebar"><?php echo $roadcount;?></span></span></span></a>
        </div>
        ...
        <style>
            ...
            <span class="barChart__bar"><span class="barChart__barFill" style="text-align:right"><span class="scorebar"><?php echo $officecount;?></span></span></span></span></a>
        ...
        <div class="barChart__row" data-value="<?php echo $companiescount;?>">
            ...
            <span class="barChart__bar"><span class="barChart__barFill" style="text-align:right"><span class="scorebar"><?php echo $companiescount;?></span></span></span></span></a>
        </div>
        ...
        <div class="barChart__row" data-value="<?php echo $policecount;?>">
            ...
            <span class="barChart__bar"><span class="barChart__barFill" style="text-align:right"><span class="scorebar"><?php echo $policecount;?></span></span></span></span></a>
        </div>
        ...
        <div class="barChart__row" data-value="<?php echo $newscount;?>">
            ...
            <span class="barChart__bar"><span class="barChart__barFill" style="text-align:right"><span class="scorebar"><?php echo $newscount;?></span></span></span></span></a>
        </div>
        ...
        <div class="barChart__row" data-value="<?php echo $fraudcount;?>">
            ...
            <span class="barChart__bar"><span class="barChart__barFill" style="text-align:right"><span class="scorebar"><?php echo $fraudcount;?></span></span></span></span></a>
        </div>
    </div>
