...
.barChart__bar { height: 24px;margin-bottom:6px}
...
.bar-left ul li{    background: url(images/img3_03.png);margin-top: 33px;padding: 5px;color: #fff;font-family: 'Open Sans', sans-serif;width:245px;}
...
<div class="bar">
	...
	$getcomplaints = $frontend_obj->getallcategorycomplaints($categories->id);	
			...
			if($categories->id!=7){
				...
				?>
           <a href="rankinner.php?id=<?php echo $categories->id?>"> <li><img src="uploads/homeimg/<?php echo $categories->image;?>"> <span><?php echo $categories->name;?> </span></li></a>
			<?php } }?>
