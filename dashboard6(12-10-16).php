...
$getallresults=$frontend_obj->getcategorycountfordashboard($_GET['cid']);/*---open and close----*/

$compliantcount = count($getallresults);/*------count we get----------*/
...
<div class="bar">
  ...
  <div class="bar-left">
            ...
            <?php  
			  ...
			  $rt=$_GET['sid'];
			?>      					
				<li  <?php if($rt==$catlist->id){?> style="width:100%; background:url(images/img31_03.png) no-repeat; margin-bottom:10px; padding:5%;" <?php }?> ><a href="dashboard6.php?cid=<?php echo $_GET['cid']; ?>&sid=<?php echo $catlist->id; ?>"><?php echo ucfirst($catlist->department_name); ?></a></li>
             <?php } ?>  
            </ul>
        </div>
...
<p><a href="rankcategory1.php?cid=<?php echo $_GET['cid']?>&sid=<?php echo $_GET['sid'];?>">Total Posted Cases: <?php echo count($getallresults);?></a>, <?php if($closedcompcnt != 0){?><a href="rankcategory1.php?cid=<?php echo $_GET['cid']?>&sid=<?php echo $_GET['sid'];?>&status=Closed">Completed Cases: <?php echo $closedcompcnt;?></a> <?php }else{?> Completed Cases: <?php echo $closedcompcnt;?> <?php }?></p>
...
{?>
	<p><a href="rankcategory1.php?cid=<?php echo $_GET['cid']?>&sid=<?php echo $_GET['sid']?>&countid=<?php echo $_GET['countid'];?>">Total Posted Cases: <?php echo count($getallresults);?></a>, <?php if($closedcompcnt != 0){?><a href="rankcategory1.php?cid=<?php echo $_GET['cid']?>&sid=<?php echo $_GET['sid']?>&countid=<?php echo $_GET['countid']?>&status=Closed">Completed Cases: <?php echo $closedcompcnt;?></a><?php }else{?> Completed Cases: <?php echo $closedcompcnt;?> <?php }?></p>
...
{ ?>
	<p><a href="rankcategory1.php?cid=<?php echo $_GET['cid']?>&todate=<?php echo $_GET['todate']?>&fromdate=<?php echo $_GET['fromdate'];?>">Total Posted Cases: <?php echo count($getallresults);?></a>, <?php if($closedcompcnt != 0){?><a href="rankcategory1.php?cid=<?php echo $_GET['cid']?>&todate=<?php echo $_GET['todate']?>&fromdate=<?php echo $_GET['fromdate']?>">Completed Cases: <?php echo $closedcompcnt;?></a><?php }else{?> Completed Cases: <?php echo $closedcompcnt;?> <?php }?></p>
	
<?php }

elseif($_GET['sid']!='' && $_GET['fromdate']!='' && $_GET['todate']!='')
{ ?>
	<p><a href="rankcategory1.php?cid=<?php echo $_GET['cid']?>&sid=<?php echo $_GET['sid']?>&todate=<?php echo $_GET['todate']?>&fromdate=<?php echo $_GET['fromdate'];?>">Total Posted Cases: <?php echo count($getallresults);?></a>, <?php if($closedcompcnt != 0){?><a href="rankcategory1.php?cid=<?php echo $_GET['cid']?>&sid=<?php echo $_GET['sid']?>&todate=<?php echo $_GET['todate']?>&fromdate=<?php echo $_GET['fromdate']?>">Completed Cases: <?php echo $closedcompcnt;?></a><?php }else{?> Completed Cases: <?php echo $closedcompcnt;?> <?php }?></p>
...
<?php }
    ...
    <p><a href="rankcategory1.php?cid=<?php echo $_GET['cid']?>">Total Posted Cases: <?php echo count($getallresults);?></a>, <?php if($closedcompcnt != 0){?><a href="rankcategory1.php?cid=<?php echo $_GET['cid']?>&status=Closed">Completed Cases: <?php echo $closedcompcnt;?></a><?php }else{?> Completed Cases: <?php echo $closedcompcnt;?> <?php }?></p>
