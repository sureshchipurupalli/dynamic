...
$bannerimage = $callConfig->freeimageUploadcomncode("banner",'bannerimage',"../uploads/homeimg/","../uploads/homeimg/thumbs/",$post['chdn_image'],'','');
...
$fieldnames=array('name'=>$post['banner'],'banner'=>$bannerimage,'description'=>$post['description'],'image'=> $bannerpic,'image1'=> $eventimage,'status'=>$post['status']);
