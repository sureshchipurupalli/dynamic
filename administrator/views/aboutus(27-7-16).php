...
error_reporting(0);
 ...
 include ("includes/header.php") ;
	...
	{
		$details=$pagesObj->insertAboutus($_POST);
		
		}
		
		$pagedetails=$pagesObj->getAllaboutus();
		 $indivdata=$pagesObj->getAboutus($_GET['id']);
		
		if($_POST['submit']=='Update')
		{
		
			$updatedetails=$pagesObj->updateAboutus($_POST,$_GET['id']);
			}
	...
	if(isset($_GET['id']) && $_GET['id']!="")
		...
		if($_GET['action']=="delete"){
			...
			$pagesObj->DeleteAboutus($_GET['id']); 
...
<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						...
						<div class="box-icon">
							<a href="index.php?option=com_aboutus_insert"><img src="img/add_icon.png"></a>
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									...
									if (q) { window.location = 'index.php?option=com_aboutus&action=delete&id=<?php echo $page->id;?>'; return false;}">
