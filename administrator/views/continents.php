...
include("model/continent.class.php");
$continentObj=new continentClass();

	if($_POST['submit']=="Submit")
	{
	//print_r($_POST);
		$details=$continentObj->insertContinent($_POST);
	}
		
		
		$countrydetails=$continentObj->getAllContinents();
		$indivdata=$continentObj->getContinent($_GET['id']); 
	 ...
	 if(isset($_GET['id']) && $_GET['id']!="")
		...
		if($_POST['submit']=='Update')
		{
			...
			$updatedetails=$continentObj->updateContinent($_POST,$_GET['id']);
		...
		if($_GET['action']=="delete")
		{
			...
			$continentObj->DeleteContinent($_GET['id']);
	...
	?>
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">Continent List</a></li>
			</ul>
			
			<?php if($option=='com_continent'){ ?>
			
<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span><?php echo $hdn_value1;?> Continent
						<div class="box-icon">
							<a href="index.php?option=com_continent_insert"><img src="img/add_icon.png"></a>
						  ...
						  { ?>							
							...
							<tr>
								...
								<!--<td>< ?php echo $subscriber->Image;?> </td>-->
									...
									<td class="center"><?php echo $country->title;?></td>
								...
								<td class="center">
									...
									<a class="btn btn-info" title="Edit" href="index.php?option=com_continent_edit&id=<?php echo $country->id;?>">
										<i class="halflings-icon white edit"></i>                                            
									</a>
									<a class="btn btn-danger" title="Delete" href="#" onClick="var q = confirm('Are you sure you want to delete selected record?'); 
									if (q) { window.location = 'index.php?option=com_continent&action=delete&id=<?php echo $country->id;?>'; return false;}">
...
<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span><?php echo $hdn_value1;?> Continent List</h2>
						<div class="box-icon">
							<a href="index.php?option=com_continent"><img src="img/back_icon.png"></a>
					...
					<div class="box-content">
						<form class="form-horizontal" method="post" enctype="multipart/form-data">
						  ...
						  <div class="control-group">
							  <label class="control-label" for="typeahead">Continent Name</label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="typeahead" name="country_name" value="<?php echo $indivdata->title;?>" >
