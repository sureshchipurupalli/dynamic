...
include("model/whatwedo.class.php");
$whatObj=new whatwedoClass();
//$whatdetails=$whatObj->getAllWhatwedo();
						  ...
						  { ?>							
							...
							<tr>
								...
								<td class="center">
									...
									<a class="btn btn-info" title="Edit" href="index.php?option=com_whatwedo_edit&id=<?php echo $what->id;?>">
										<i class="halflings-icon white edit"></i>                                            
									</a>
									<a class="btn btn-danger" title="Delete" href="#" onClick="var q = confirm('Are you sure you want to delete selected record?'); 
									if (q) { window.location = 'index.php?option=com_whatwedo&action=delete&id=<?php echo $what->id;?>'; return false;}">
