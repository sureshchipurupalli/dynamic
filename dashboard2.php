...
if($_GET['fromdate']!="" && $_GET['todate']!="" & $_GET['sid']!=""){
...
<script>
function legaldetails1(category){
	alert(category.getAttribute("value"));
	//alert(category);
...
document.getElementById("data").innerHTML=xmlhttp.responseText;
				...
				xmlhttp.open("GET","getlegaldata.php?q="+category.getAttribute("value"),true);
				xmlhttp.send();
...
<script>
function legaldetails(category){
	//alert(category.getAttribute("value"));
	var val1 = category.getAttribute("value");
	alert(val1);
 $.ajax({
            url: 'getlegaldata.php',
            type: 'GET',
            dataType: 'html',
			 data: { text1: val1 },
...
<div class="bar">
  ...
  <div class="bar-left">
            ...
            <?php  
			  ...
			  $rt=$_GET['sid'];
			?>      					
				<li  <?php if($rt==$catlist->id){?> style="width:100%; background:url(images/img31_03.png) no-repeat; margin-bottom:10px; padding:5%;" <?php }?> ><a href="dashboard2.php?cid=<?php echo $_GET['cid']; ?>&sid=<?php echo $catlist->id; ?>" value=<?php echo $catlist->id; ?> onClick="legaldetails(this);"><?php echo ucfirst($catlist->department_name); ?></a></li>
             <?php } ?>  
            </ul>
        </div>
