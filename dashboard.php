...
$category=$frontend_obj->getCategory($_GET['id']);
$result=$frontend_obj->getCountofcategorycomplaints($_GET['id']);
$completed=$frontend_obj->getcompletedcomplaints($_GET['id']);
?>
...
<div class="dashboard">
	<div class="mid_wrap">
    <p>Total Posted Cases: <span></span><?php echo count($result);?></span>, Completed Cases: <span><?php echo count($completed);?>
